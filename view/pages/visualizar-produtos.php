<?php 
 ...
 ?>
    ...
    if ($id !== null) {
        $produto_encontrada = false; // Variável para verificar se encontramos a categoria

        
        foreach ($produtos as $prod) {
            if ($prod['id'] == $id) {
                // Se encontrar o produto, armazena os dados
                $nome = $prod['nome'];
        ...
        // Se o produto não for encontrado, define as variáveis com uma mensagem de erro
        ...
        $nome = "ID inválido";
        $descricao = "Nenhum produto foi especificado.";
    }
?>
...
<body>
    ...
    <section class="">
        ...
        <h3>Produto: <?php echo ($nome); ?></h3>
        <p>Descrição: <br> <?php echo ($descricao); ?></p>
        <p>Categoria: <br> <?php echo ($categoria); ?></p>
        <p>Preço: <br> <?php echo ($preco); ?></p>
